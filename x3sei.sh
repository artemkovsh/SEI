...
if [ ! $NODENAME ]; then
	read -p "Имя ноды: " NODENAME < /dev/tty
...
echo -e "\e[1m\e[32m1. Установка необходимого на сервер.... \e[0m" && sleep 1

sudo apt update && sudo apt upgrade -y

echo -e "\e[1m\e[32m2. Установливаем ноду... \e[0m" && sleep 1
...
echo -e "\e[1m\e[32m3. Скачиваем дополнительные файлы... \e[0m" && sleep 1
...
echo -e "\e[1m\e[32m4. Запускаем сервис ноды... \e[0m" && sleep 1
